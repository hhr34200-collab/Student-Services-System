...
<div class="profile-container">
    ...
    <div class="page-header">
        ...
        <p>يمكنك الاطلاع على بياناتك الأكاديمية وتحديث معلومات حسابك</p>
    </div>
    ...
    <div class="profile-card">
        ...
        <div class="card-body">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    <span>الكلية</span>
                    <strong>{{ $student->college->college_name }}</strong>
                </div>

                <div class="info-item">
                    <span>القسم</span>
                    <strong>{{ $student->department->department_name }}</strong>
                </div>
